...
RSpec.describe CabbookingController, :type => :controller do
  ...
  describe "Abhishek_2012007: GET new" do
  ...
  describe "Abhishek_2012007: POST createCust" do
  ...
  describe "Abhishek_2012007: POST findCust" do
    it "Finds a customer based on its customer ID" do

      user_Params = {:cabObj => {"custId" => "5488"}}
      post :findCust, user_Params, valid_session
      user=assigns(:cabObj)

      expect(user.custId).to be=="5488"
  ...
  describe "Abhishek_2012007: POST delCust" do
  ...
  describe "Abhishek_2012007: POST book" do
    it "Creates a new booking and allocates a new booking id" do

      user_Params = {:cabObj => {"custId" => "2225", "source" => "Okhla", "destination" => "Gurgaon", "pickup" => "1430"}}
      post :book, user_Params, valid_session
      user=assigns(:cabObj)

      expect(user.custName).to be=="Abhishek"
